...
public interface ParametersFilter {
	static ParametersFilter typesAccepted(Class<?>... parameterTypes) {
		return Types.accepting(parameterTypes);
	}

	static ParametersFilter typesExact(Class<?>... parameterTypes) {
		return Types.exact(parameterTypes);
	}
	...
	final class Types implements ParametersFilter {
	...
	final class Count implements ParametersFilter {
